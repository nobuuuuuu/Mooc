...
#### [Why you would learn react js](#why-you-would-learn-react-js)

#### [Educational objective and prerequisites](#educational-objective-and-prerequisites)

#### [Mooc summarize](#mooc-summarize)

### [Start off on the right foot](#start-off-on-the-right-foot)

#### [Work environment installations](#work-environment-installations)

#### [Let's try it](#lets-try-it)

### [Understand some important concepts](#understand-some-important-concepts)
...
### [Build our first application](#build-our-first-application)

#### [Create and organize our files](#create-and-organize-our-files)

#### [Build the first component with props](#build-the-first-component-with-props)

#### [Define methods](#define-methods)

#### [Set up a local state](#set-up-a-local-state)

#### [Update the local state with setState](#update-the-local-state-with-setstate)

#### [Exercise Build a calculator](#exercise-build-a-calculator)

### [React and RESTful API](#v.-react-and-restful-api)

#### [a. What a RESTful API is ?](#what-a-resftul-api-is)

#### [b. Setup the project](#setup-the-projet)

#### [c. Calling the API](#calling-the-api)

#### [d. Manipulate the API return](#manipulate-the-api-return)
