...
•	[color=#F0F0F0]$ cd digital-ocean-tutorial[/color]

Then run this command to install Axios:
•	[color=#F0F0F0]$ npm install axios[/color]
...
•	[color=#F0F0F0]$ nano src/PersonList.js[/color]

Add the following code to the component:
- File: Project/src/PersonList.js
